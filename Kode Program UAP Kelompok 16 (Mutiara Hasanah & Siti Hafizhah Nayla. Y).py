...
def lagu():
    ...
    for penyanyi in data_lagu[genre]:
        print(f"\n{penyanyi[0]}")
        for lagu in penyanyi[1:]:
            print(f"  - {lagu}")
...
def film():
    ...
    for negara in data_film[genre]:
        print(f"\n{negara[0]}")
        for judul in negara[1:]:
            print(f"  - {judul}")
